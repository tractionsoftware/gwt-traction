 ...
 * {@link com.tractionsoftware.gwt.history.client.impl.RawHistoryImplTimer}.
 * 
 ...
 */
class RawHistoryImplSafari extends RawHistoryImplTimer {
  ...
  protected native void nativeUpdate(String historyToken) /*-{
    ...
    $wnd.location = $wnd.location.href.split('#')[0] + '#' +
      this.@com.tractionsoftware.gwt.history.client.impl.RawHistoryImpl::encodeFragment(Ljava/lang/String;)(historyToken);
  }-*/;
}
